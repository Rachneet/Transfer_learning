...
# train model
def train(batch_size, num_epochs, learning_rate,mod, datapath):
    ...
    training_set = MyDataset(datapath + "train_data_10m.csv")
    # test_set = MyDataset(datapath + "test.csv")
    validation_set = MyDataset(datapath + "validation_data_2m.csv")
    ...
    best_accuracy = 0
    output_file = open(datapath + "logs_10M.txt", "w")
    ...
    for epoch in range(num_epochs):
        ...
        if test_metrics["accuracy"] > best_accuracy:
            ...
            torch.save(model, datapath + "trained_model_10M")


if __name__ == '__main__':
    # train model and get metrics
    train(1024, 20, 0.01, "/home/rachneet/Amazon_data/")